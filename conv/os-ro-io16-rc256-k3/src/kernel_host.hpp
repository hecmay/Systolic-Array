      ...
      for (int c2 = 0; c2 <= 1; c2 += 1) {
        ...
        for (int c4 = 0; c4 <= 3; c4 += 1) {
          ...
          for (int c5 = 0; c5 <= 3; c5 += 1)
            for (int c6 = 0; c6 <= 65; c6 += 1)
              for (int c7 = 0; c7 <= 15; c7 += 1)
                cin_to[cnt++] = cin_from[((8 * c1 + 2 * c4 + c5) * 130 + (64 * c2 + c6)) * 16 + c7];
        }
      }
}
/* Helper Function */
            ...
            for (int c6 = 0; c6 <= 2; c6 += 1)
              for (int c7 = 0; c7 <= 2; c7 += 1)
                for (int c8 = 0; c8 <= 15; c8 += 1)
                  w_to[cnt++] = w_from[(((8 * c0 + 2 * c4 + c5) * 3 + c6) * 3 + c7) * 16 + c8];
        }
      }
}
/* Helper Function */
            ...
            for (int c6 = 0; c6 <= 1; c6 += 1)
              for (int c7 = 0; c7 <= 63; c7 += 1)
                for (int c8 = 0; c8 <= 1; c8 += 1)
                  cout_to[((8 * c1 + 2 * c4 + c6) * 128 + (64 * c2 + c7)) * 16 + (8 * c0 + 2 * c5 + c8)] = cout_from[cnt++];
          }
        }
      }
}
