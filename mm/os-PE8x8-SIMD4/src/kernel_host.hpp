        ...
        for (int c3 = 0; c3 <= 7; c3 += 1) {
          ...
          for (int c4 = 0; c4 <= 127; c4 += 1)
            for (int c5 = 0; c5 <= 1023; c5 += 1)
              A_to[cnt++] = A_from[(1024 * c0 + 128 * c3 + c4) * 4096 + (1024 * c2 + c5)];
        }
      }
}
/* Helper Function */
    ...
    for (int c1 = 0; c1 <= 3; c1 += 1)
      for (int c2 = 0; c2 <= 3; c2 += 1) {
        ...
        for (int c3 = 0; c3 <= 7; c3 += 1) {
          ...
          for (int c4 = 0; c4 <= 127; c4 += 1)
            for (int c5 = 0; c5 <= 1023; c5 += 1)
              B_to[cnt++] = B_from[(1024 * c1 + 128 * c3 + c4) * 4096 + (1024 * c2 + c5)];
        }
      }
}
/* Helper Function */
      ...
      for (int c3 = 0; c3 <= 7; c3 += 1) {
        ...
        for (int c4 = 0; c4 <= 7; c4 += 1) {
          ...
          for (int c5 = 0; c5 <= 127; c5 += 1)
            for (int c6 = 0; c6 <= 127; c6 += 1)
              C_to[(1024 * c0 + 128 * c4 + c5) * 4096 + (1024 * c1 + 128 * c3 + c6)] = C_from[cnt++];
        }
      }
    }
}
